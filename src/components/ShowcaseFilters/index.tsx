...
import {Tags, TagList, type TagType} from '@site/src/data/docs';
import Heading from '@theme/Heading';
import ShowcaseTagSelect from '../ShowcaseTagSelect';
import OperatorButton from '../OperatorButton';
import ClearAllButton from '../ClearAllButton';
import {useFilteredDocs, useSiteCountPlural} from '../_utils';
...
function HeadingText() {
  ...
  return (
    <div className={styles.headingText}>
      <Heading as="h2">
        <Translate id="showcase.filters.title">フィルター</Translate>
      </Heading>
      <span>{siteCountPlural(filteredDocs.length)}</span>
    </div>
  );
}
